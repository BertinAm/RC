...
<head>
    ...
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1">
    <title>Rc Systems Dashboard</title>
    <!-- ================= Favicon ================== -->
    <!-- Standard -->
    <link rel="shortcut icon" href="http://placehold.it/64.png/000/fff">
    <!-- Retina iPad Touch Icon-->
            ...
            <div class="nano-content">
                <ul>
                    <div class="logo"><a href="home.php">
                            <!-- <img src="assets/images/logo.png" alt="" /> --><span>RC Systems</span></a></div>
                    <li class="label">Main</li>
                    ...
                    clearstatcache<li class="label">Extra</li>
                    ...
                    <li><a href="page-login.php"><i class="ti-file"></i> Documentation</a></li>
                    <li><a href="page-logout.php"><i class="ti-close"></i> Logout</a></li>
                </ul>
            </div>
        </div>
    </div>
            ...
            <div class="container-fluid">
                ...
                <section id="main-content">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <div class="footer">
                                <p>2022 © RC SYstems Board. - <a href="#">example.com</a></p>
                            </div>
                        </div>
                    </div>
                </section>
...
>>>>>>> 0ea6d457f76df13fea927f96d9ad056a07a2c7f9:home.php
</html>