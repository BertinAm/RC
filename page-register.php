                ...
                <div class="col-lg-6">
                    <div class="login-content">
                        <div class="login-logo">
                            <a href="index.html"><span>RC Sytems</span></a>
                        </div>
                        <div class="login-form">
                            <h4>Register to Administration</h4>
                                <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-flat m-b-30 m-t-30" value="submit">Register</button>
                                    <button type="reset" class="btn btn-secondary btn-flat m-b-30 m-t-30" value="Reset"> Reset</button>
                                
                                    <div class="register-link m-t-15 text-center">
                                    <p>Are you already registered? <a href="page-login.php">Login here</a>.</p>
                                    </div>
                                </form>
                            </div> 
                            </div>
